...
/**
 * This class stands for WSI4_PointRelais_Recherche StructType
 * @subpackage Structs
 */
class WSI4_PointRelais_Recherche extends AbstractStructBase
{
    /**
     * The NombreResultats
    ...
    public $Security;
    /**
     * Constructor method for WSI4_PointRelais_Recherche
     * @uses WSI4_PointRelais_Recherche::setNombreResultats()
     * @uses WSI4_PointRelais_Recherche::setEnseigne()
     * @uses WSI4_PointRelais_Recherche::setPays()
     * @uses WSI4_PointRelais_Recherche::setNumPointRelais()
     * @uses WSI4_PointRelais_Recherche::setVille()
     * @uses WSI4_PointRelais_Recherche::setCP()
     * @uses WSI4_PointRelais_Recherche::setLatitude()
     * @uses WSI4_PointRelais_Recherche::setLongitude()
     * @uses WSI4_PointRelais_Recherche::setTaille()
     * @uses WSI4_PointRelais_Recherche::setPoids()
     * @uses WSI4_PointRelais_Recherche::setAction()
     * @uses WSI4_PointRelais_Recherche::setDelaiEnvoi()
     * @uses WSI4_PointRelais_Recherche::setRayonRecherche()
     * @uses WSI4_PointRelais_Recherche::setTypeActivite()
     * @uses WSI4_PointRelais_Recherche::setNACE()
     * @uses WSI4_PointRelais_Recherche::setSecurity()
     ...
     */
    public function __construct($nombreResultats = null, $enseigne = null, $pays = null, $numPointRelais = null, $ville = null, $cP = null, $latitude = null, $longitude = null, $taille = null, $poids = null, $action = null, $delaiEnvoi = null, $rayonRecherche = null, $typeActivite = null, $nACE = null, $security = null)
    {
        $this
    ...
    /**
     * Set NombreResultats value
     * @param int $nombreResultats
     * @return \MondialRelay\StructType\WSI4_PointRelais_Recherche
     */
    public function setNombreResultats($nombreResultats = null)
    {
        // validation for constraint: int
        if (!is_null($nombreResultats) && !(is_int($nombreResultats) || ctype_digit($nombreResultats))) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide an integer value, %s given', var_export($nombreResultats, true), gettype($nombreResultats)), __LINE__);
        }
