...
/**
 * This class stands for WSI2_RecherchePointRelaisHoraires StructType
 * @subpackage Structs
 */
class WSI2_RecherchePointRelaisHoraires extends AbstractStructBase
{
    /**
     * The Enseigne
    ...
    public $Security;
    /**
     * Constructor method for WSI2_RecherchePointRelaisHoraires
     * @uses WSI2_RecherchePointRelaisHoraires::setEnseigne()
     * @uses WSI2_RecherchePointRelaisHoraires::setPays()
     * @uses WSI2_RecherchePointRelaisHoraires::setVille()
     * @uses WSI2_RecherchePointRelaisHoraires::setCP()
     * @uses WSI2_RecherchePointRelaisHoraires::setTaille()
     * @uses WSI2_RecherchePointRelaisHoraires::setPoids()
     * @uses WSI2_RecherchePointRelaisHoraires::setAction()
     * @uses WSI2_RecherchePointRelaisHoraires::setSecurity()
     ...
     * Set Enseigne value
     * @param string $enseigne
     * @return \MondialRelay\StructType\WSI2_RecherchePointRelaisHoraires
     */
