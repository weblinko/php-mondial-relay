...
/**
 * This class stands for WSI2_DetailPointRelais StructType
 * @subpackage Structs
 */
class WSI2_DetailPointRelais extends AbstractStructBase
{
    /**
     * The Enseigne
    ...
    public $Security;
    /**
     * Constructor method for WSI2_DetailPointRelais
     * @uses WSI2_DetailPointRelais::setEnseigne()
     * @uses WSI2_DetailPointRelais::setNum()
     * @uses WSI2_DetailPointRelais::setPays()
     * @uses WSI2_DetailPointRelais::setSecurity()
     ...
     * Set Enseigne value
     * @param string $enseigne
     * @return \MondialRelay\StructType\WSI2_DetailPointRelais
     */
