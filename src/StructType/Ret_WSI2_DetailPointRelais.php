...
/**
 * This class stands for ret_WSI2_DetailPointRelais StructType
 * @subpackage Structs
 */
class Ret_WSI2_DetailPointRelais extends Ret_
{
    /**
     * The Num
    ...
    public $URL_Plan;
    /**
     * Constructor method for ret_WSI2_DetailPointRelais
     * @uses Ret_WSI2_DetailPointRelais::setNum()
     * @uses Ret_WSI2_DetailPointRelais::setLgAdr1()
     * @uses Ret_WSI2_DetailPointRelais::setLgAdr2()
     * @uses Ret_WSI2_DetailPointRelais::setLgAdr3()
     * @uses Ret_WSI2_DetailPointRelais::setLgAdr4()
     * @uses Ret_WSI2_DetailPointRelais::setCP()
     * @uses Ret_WSI2_DetailPointRelais::setVille()
     * @uses Ret_WSI2_DetailPointRelais::setPays()
     * @uses Ret_WSI2_DetailPointRelais::setLocalisation1()
     * @uses Ret_WSI2_DetailPointRelais::setLocalisation2()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Lundi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Mardi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Mercredi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Jeudi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Vendredi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Samedi()
     * @uses Ret_WSI2_DetailPointRelais::setHoraires_Dimanche()
     * @uses Ret_WSI2_DetailPointRelais::setInformation()
     * @uses Ret_WSI2_DetailPointRelais::setURL_Photo()
     * @uses Ret_WSI2_DetailPointRelais::setURL_Plan()
     * @param string $num
     * @param string $lgAdr1
     * @param string $lgAdr2
     * @param string $lgAdr3
     ...
     * Set Num value
     * @param string $num
     * @return \MondialRelay\StructType\Ret_WSI2_DetailPointRelais
     */
